...
activities = {
    ...
    "Math Olympiad": {
        "description": "Advanced problem-solving and preparation for mathematics competitions",
    ...
    "Digital Art Studio": {
        "description": "Create digital artwork using design software and graphic tablets",
